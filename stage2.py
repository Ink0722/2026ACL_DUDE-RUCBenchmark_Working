...
K = 17
MAX_ITERATIONS = 5
OUTPUT_ROOT = "stage2_result"


class EvalEXP:
    def __init__(self, 
                 model_id="Qwen/Qwen2.5-VL-3B-Instruct",
                 adapter_dir="Qwen2.5-VL-3B-Click-NewPlan3",
    ...
    def load_exp_summarizer(self):
        ...
        """加载经验总结模型 (GLM)"""
        # TODO:这个static_template记得是要改的(要考虑加Previous Experience，得告诉他修改的是现有经验，没有的话就重新写一条)！
    ...
    def opt_exp_context(self, 
        ...
        while len(self.failure) != 0 and it < max_iterations:
            ...
            for item in test_samples:
                ...
                if use_exp and exp:
                    # TODO：植入经验，参考 datasets.py 逻辑，保持通顺（看一下怎么植入的）
